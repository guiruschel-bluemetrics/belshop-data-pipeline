SELECT
    ...
    -- Produtos (Elo necessário para chegar ao fornecedor)
    P."pk produtos",
    P.nome AS prod_nome,
    P.grupo AS prod_grupo,
    P.subgrupo AS prod_subgrupo,
    P.marca AS prod_marca,
...
-- Junções para chegar nos fornecedores:
